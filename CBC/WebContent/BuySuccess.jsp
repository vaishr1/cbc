...
<%
	...
	ind.submitData(userId,nstock,StockName,punit,total,tai,chargeBack,balanceAmount);
	}
	else if(userType.equalsIgnoreCase("fundU")){
		FundBO ind=new FundBO();
		ind.submitDataFund(fundId,nstock,StockName,punit,total,tai,chargeBack,balanceAmount);
...
<div id=center>
<br><br>
<h2><font color="red">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspStocks are bought successfully</font></h2>
